...
NDefines.NMilitary.EXPERIENCE_COMBAT_FACTOR = 0.05 -- combat bonus per level of army experience starts from -25% capped at +75%
...
-- Navy
NDefines.NNavy.COMBAT_MAX_GROUPS = 4
NDefines.NNavy.NAVY_VISIBILITY_BONUS_ON_RETURN_FOR_REPAIR = 0.6
NDefines.NNavy.MANPOWER_LOSS_RATIO_ON_STR_LOSS = 0.01
